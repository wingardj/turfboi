        ...
        var q, r, t, c = a.document,
            ...
            n = function() {
                for (var b = 0; l.length > b; b++) {
                    ...
                    d && f && !h[d] && (c.styleSheet && c.styleSheet.rawCssText ? (p(c.styleSheet.rawCssText, d, e), h[d] = !0) : (!/^([a-zA-Z:]*\/\/)/.test(d) && !k || d.replace(RegExp.$1, "").split("../index.html")[0] === a.location.host) && m.push({
                        href: d,
                        media: e
                    }))
                }
            ...
            p = function(a, b, c) {
                var d = a.match(/@media[^\{]+\{([^\{\}]*\{[^\}\{]*\})+/gi),
                    g = d && d.length || 0;
                b = b.substring(0, b.lastIndexOf("../index.html"));
                var h = function(a) {
