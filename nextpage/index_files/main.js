...
; (function ($) {
    ...
    $(".dark").on('click', function (e) {
        ...
        $(".tf-text").addClass("s1")
        document.getElementById("logo_header").src = "asset/images/logo/logo_dark.html";
        document.getElementById("logo_footer").src = "asset/images/logo/logo_dark.html";
        document.getElementById("moon_dark").src = "asset/images/icon/moon-2.html";
    });
    ...
    $(".light").on('click', function (e) {
        ...
        document.getElementById("logo_header").src = "asset/images/logo/logo.html";
        document.getElementById("logo_footer").src = "asset/images/logo/logo2.html";
        document.getElementById("moon_dark").src = "asset/images/icon/moon.html";
    });
